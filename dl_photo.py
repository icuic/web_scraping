...
class Spider():
    ...
    def __init__(self):
        ...
        self.filePath = ('C:\\Users\\dell\\Desktop\\'+ keyWord + '\\')
    ...
    def get_pageNum(self):
        ...
        total = ""
        url = ("https://wallhaven.cc/search?q={}").format(keyWord)
    ...
    def getLinks(self,number):
        ...
        url = ("https://wallhaven.cc/search?q={}&page={}").format(keyWord,number)
        try:
            html = requests.get(url)
            selector = etree.HTML(html.text)
    ...
    def download(self,url,count):
        try:
            ...
            selector = etree.HTML(type.text)
            desc = selector.xpath('/html/body/aside/div/div[1]/div[2]/dl/dd[3]/text()')
            if 'PNG' in desc:
                pic_format = '.png'
            else:
                pic_format = '.jpg'
        ...
        string = url.strip('https://wallhaven.cc/wallpaper/tags/')
        # https://w.wallhaven.cc/full/d5/wallhaven-d5yqpl.jpg
        html = 'https://w.wallhaven.cc/full/' + string[0:2] + '/wallhaven-' + string + pic_format
        pic_path = (self.filePath + keyWord + str("_") + str(count) + pic_format )
        try:
            pic = requests.get(html,headers = self.headers)
            if pic.content.__sizeof__() < 10240:
                return
